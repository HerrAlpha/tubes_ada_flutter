...
class ProfileInvestor extends StatefulWidget {
  ...
  @override
  State<ProfileInvestor> createState() => _ProfileInvestorState();
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _cardProfile("Total Profit",
              CurrencyFormat.convertToIdr(profile!['total_profit'] == null ? 0:profile!['total_profit'], 0)),
          SizedBox(
            height: 30,
          ),
          Container(
